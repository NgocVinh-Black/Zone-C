...
Singleton {
    ...
    readonly property QtObject block: QtObject {
        ...
        readonly property real borderAlpha: 0.08
    ...
    readonly property QtObject workspace: QtObject {
        ...
        readonly property real hoverAlpha: 0.1
        readonly property real occupiedAlpha: 0.15
    }
    ...
    readonly property QtObject media: QtObject {
        ...
        readonly property int compactBelowWidth: 1920
    }

    readonly property QtObject clock: QtObject {
        readonly property int paddingX: Scale.s(8)
        readonly property int weatherGap: Scale.s(16)
    ...
    readonly property QtObject popup: QtObject {
        readonly property int marginTop: Scale.s(60)
        readonly property int radius: Scale.s(14)
        readonly property int padding: Scale.s(12)
    ...
    readonly property QtObject anim: QtObject {
        ...
        readonly property int highlightLead: 200
        readonly property int highlightTrail: 350
    }
}
